...
export default function PatientDashboard() {
  ...
  const handleRazorpayPayment = async (e) => {
    ...
    try {
      ...
      // Check if we should use the sandbox simulator overlay
  ...
  const handleSimulateVerify = async (success) => {
    ...
    // Add brief artificial delay to simulate contacting bank gateway
              ...
              <div style={{
                ...
                <style dangerouslySetInnerHTML={{__html: `
                  @media print {
                    ...
                    /* Force visible only the receipt container */
